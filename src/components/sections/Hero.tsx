  ...
  return (
    <section className="md:bg-hero-image-with-shadows w-full bg-[#d8f28d] bg-no-repeat pt-32 text-[#00643c] sm:pt-48 md:min-h-fit md:bg-[auto_70vh] md:bg-[100%_100%] md:pt-0">
      <div className="flex flex-col">
        <div className="page-container w-full space-y-8 sm:space-y-12 sm:px-14 md:mx-24 md:max-w-[25rem] md:pb-24 md:pt-48 lg:mx-16 lg:max-w-[42rem] lg:pb-36">
          <h2 className="font-display text-5xl font-black uppercase leading-none sm:text-6xl lg:text-8xl">
